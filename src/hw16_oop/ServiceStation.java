...
//используем полиморфизм для передачи праметра - массив общего типа данных (транспорты), чтобы с увеличением видов транспотра не забыть принять новый параметр
//от куратора - На методы, которые переопределены, лучше вешать аннотацию @Override
